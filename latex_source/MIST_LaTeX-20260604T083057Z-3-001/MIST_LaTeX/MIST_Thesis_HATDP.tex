...
% ---- Bengali font for the Bengali abstract (সারসংক্ষেপ) ----
\newfontfamily\bengalifont[Path=fonts/,Extension=.ttf,UprightFont=NotoSerifBengaliMerged-Regular,BoldFont=NotoSerifBengaliMerged-Bold,Script=Bengali]{NotoSerifBengaliMerged-Regular}
...
% front-matter unnumbered heading helper (NOT listed in Contents)
\newcommand{\frontchap}[1]{%
  \clearpage\thispagestyle{fancy}%
  \begin{center}\Large\bfseries #1\end{center}\vspace{6pt}}
% front-matter unnumbered heading helper (listed in Contents)
\newcommand{\frontchaptoc}[1]{%
  \clearpage\thispagestyle{fancy}%
  \phantomsection\addcontentsline{toc}{chapter}{#1}%
  \begin{center}\Large\bfseries #1\end{center}\vspace{6pt}}

% Board-of-Examination signature block (template page-i style):
% #1 name  #2 title/designation  #3 department  #4 role  #5 sub-role
\newcommand{\exblock}[5]{%
  \par\vspace{15pt}\noindent
  \rule{6.2cm}{0.4pt}\par\nobreak\vspace{1pt}
  \noindent\begin{minipage}[t]{0.62\textwidth}\raggedright\strut#1\\\strut#2\\\strut#3\end{minipage}%
  \hfill
  \begin{minipage}[t]{0.34\textwidth}\raggedleft\strut#4\\\strut#5\\\strut Board of Examination\end{minipage}\par}
...
\vspace{0.7in}
{\large\bfseries Md Moinul Haque\quad(SN: 202216206)\par}
\vspace{4pt}
{\large\bfseries Md Reyaz Uddin\quad(SN: 202216211)\par}
\vspace{0.7in}
{\large\bfseries B.Sc. ENGINEERING THESIS\par}
\vspace{0.7in}
\includegraphics[width=1.1in]{logoMIST.png}\par
\vspace{0.25in}
{\bfseries DEPARTMENT OF ELECTRICAL, ELECTRONIC AND\\ COMMUNICATION ENGINEERING\par}
{\bfseries MILITARY INSTITUTE OF SCIENCE AND TECHNOLOGY\par}
{\bfseries DHAKA, BANGLADESH\par}
\vspace{0.4in}
{\large\bfseries JUNE 2026\par}
\end{titlepage}

% ===================== SPINE PAGE (template page 2) =====================
\begin{landscape}
\thispagestyle{empty}
\vspace*{\fill}
\begin{center}
\makebox[\linewidth]{\noindent\fbox{\begin{minipage}{1.8\textheight}
\vspace{15pt}
\centering
\resizebox{\linewidth}{!}{\bfseries HAQUE \& UDDIN\hspace{1em}B.Sc. ENGINEERING THESIS\hspace{1em}MIST $\bullet$ EECE $\bullet$ 2026}
\vspace{15pt}
\end{minipage}}}
\end{center}
\vspace*{\fill}
...
% ===================== TITLE PAGE (inner) -- unnumbered, like the template =====================
\thispagestyle{empty}
\begin{center}
\vspace*{0.4in}
{\large\bfseries HYBRID ADAPTIVE TRANSFORMER DIFFERENTIAL PROTECTION:\\ AN INTELLIGENT DWT--LSTM FRAMEWORK\par}
\vspace{0.5in}
{\bfseries Md Moinul Haque (SN: 202216206)\\[2pt] Md Reyaz Uddin (SN: 202216211)\par}
\vspace{0.4in}
\textit{A Thesis Submitted in Partial Fulfillment of the Requirements for the\\ Degree of Bachelor of Science in Electrical, Electronic and\\ Communication Engineering}\par
\vspace{2.0in}
\includegraphics[width=1.1in]{logoMIST.png}\par
\vspace{0.25in}
{\bfseries DEPARTMENT OF ELECTRICAL, ELECTRONIC AND\\ COMMUNICATION ENGINEERING\\ MILITARY INSTITUTE OF SCIENCE AND TECHNOLOGY\\ DHAKA, BANGLADESH\par}
\vspace{0.3in}
{\bfseries JUNE 2026\par}
\end{center}

% Roman numbering starts here so the Approval page is page i (template style)
\clearpage
\pagenumbering{roman}

% ===================== APPROVAL (template page i) =====================
\clearpage\thispagestyle{fancy}
\begin{center}
{\large\bfseries HYBRID ADAPTIVE TRANSFORMER DIFFERENTIAL PROTECTION:\\ AN INTELLIGENT DWT--LSTM FRAMEWORK\par}
\vspace{0.2in}
{B.Sc. Engineering Thesis\par}
\vspace{6pt}
{By\par}
\vspace{6pt}
{Md Moinul Haque (SN: 202216206)\\ Md Reyaz Uddin (SN: 202216211)\par}
\end{center}
\vspace{0.18in}
\noindent Approved as to style and content by the Board of Examination on \rule{2.2cm}{0.4pt} June 2026:
\vspace{0.6in}
\exblock{Cdre A N M Didarul Alam, (L), NUP, psc, BN}{Dean, Faculty of Maritime Business Studies, Bangladesh Maritime University}{}{Chairman}{(Supervisor)}
\exblock{Brigadier General K M Mustafizur Rahman, psc}{Head of the Department}{Department of EECE, MIST, Dhaka, Bangladesh}{Member}{(Ex-officio)}
\vfill
\begin{center}
Department of Electrical, Electronic and Communication Engineering\\ MIST, Dhaka
\end{center}

% ===================== DECLARATION (template page ii) =====================
\clearpage\thispagestyle{fancy}
\begin{center}
{\large\bfseries HYBRID ADAPTIVE TRANSFORMER DIFFERENTIAL PROTECTION:\\ AN INTELLIGENT DWT--LSTM FRAMEWORK\par}
\vspace{0.35in}
...
Dedicated to our parents for supporting and encouraging us to believe in ourselves.
\end{center}
\vfill

% ===================== ACKNOWLEDGEMENTS =====================
\frontchap{ACKNOWLEDGEMENTS}
Foremost, we would like to express our sincere gratitude to our supervisor, Cdre A N M Didarul Alam, (L), NUP, psc, BN, for his continuous support, patience, motivation, and immense knowledge. His guidance helped us throughout the research and writing of this thesis.

We would also like to thank the faculty members and Staffs of the Department of Electrical, Electronic and Communication Engineering, MIST, for providing the academic facilities and the research environment that made this work possible.

Finally, we must express our profound gratitude to our parents and families for their unfailing support and continuous encouragement throughout our years of study. This accomplishment would not have been possible without them.

% ===================== ABSTRACT =====================
\frontchaptoc{ABSTRACT}
\begin{center}{\bfseries Hybrid Adaptive Transformer Differential Protection:\\ An Intelligent DWT--LSTM Framework\par}\end{center}
\vspace{6pt}
...
% ===================== সারসংক্ষেপ (Bengali abstract, no English heading) =====================
\clearpage\thispagestyle{fancy}
\vspace{-2pt}
\begin{center}{\large\bfseries\bn{সারসংক্ষেপ}}\par\vspace{8pt}
{\bfseries Hybrid Adaptive Transformer Differential Protection:\\ An Intelligent DWT--LSTM Framework\par}\end{center}
\vspace{6pt}
{\bengalifont
প্রস্তাবিত থিসিস পত্রে পাওয়ার ট্রান্সফরমারে বিদ্যমান প্রচলিত পার্সেন্টেজ ডিফারেনশিয়াল সুরক্ষার সীমাবদ্ধতা দূর করতে ডিসক্রিট ওয়েভলেট ট্রান্সফর্ম (DWT) এবং লং শর্ট-টার্ম মেমোরি (LSTM) নেটওয়ার্কের সমন্বয়ে একটি যুগান্তকারী ‘হাইব্রিড অ্যাডাপ্টিভ প্রটেকশন ফ্রেমওয়ার্ক’ উপস্থাপিত হয়েছে। প্রচলিত ২য় হারমোনিক রেস্ট্রেইন্ট পদ্ধতি আধুনিক উচ্চ-ভেদ্যতাসম্পন্ন কোরের ট্রান্সফরমারে ম্যাগনেটাইজিং ইনরাশ কারেন্ট এবং বাহ্যিক ফল্টজনিত কারেন্ট ট্রান্সফরমার (CT) স্যাচুরেশনের সঠিক পার্থক্য নির্ণয়ে প্রায়শই ব্যর্থ হয়ে অনাকাঙ্ক্ষিত ট্রিপিং ঘটায়। এই সুরক্ষাজনিত সংকট সমাধানে MATLAB/Simulink পরিবেশে একটি ৩০০ MVA, ২৩০/১১ kV, Yd1 পাওয়ার ট্রান্সফরমার এবং ননলাইনার সিটি স্যাচুরেশনের উচ্চ-স্তরের ফিজিক্যাল মডেল তৈরি করে ২,৫০০টি ভিন্ন ভিন্ন ঘটনার বাস্তবসম্মত ডেটাসেট তৈরি করা হয়েছে। এই ডেটা থেকে Daubechies-4 (db4) মাদার ওয়েভলেটের ৫-লেভেল ডিকম্পোজিশন এবং পার্সিভালের উপপাদ্য প্রয়োগ করে প্রতি ফেজের জন্য অত্যন্ত কমপ্যাক্ট ৩৭-ডাইমেনশনাল ফিচার ভেক্টর বের করা হয়েছে। পরবর্তীতে, গ্লোবাল টেম্পোরাল অ্যাটেনশন মেকানিজম সংবলিত ২-লেয়ার বিশিষ্ট LSTM নেটওয়ার্কটি PyTorch-এ প্রশিক্ষণের পর ONNX ফরম্যাটের মাধ্যমে পুনরায় Simulink-এর Predict ব্লকে রিয়েল-টাইম কো-সিমুলেশনের জন্য সফলভাবে মোতায়েন করা হয়। এই সিস্টেমের মূল অভিনবত্ব হলো এর ‘হাইব্রিড ডিসিশন হ্যান্ডশেক’ আর্কিটেকচার, যেখানে LSTM ক্লাসিফায়ারটি প্রচলিত সেফটি-সার্টিফাইড অ্যাডাপ্টিভ 87T রিলের ব্লকিং বা সুপারভাইজরি ভেটো (AND Gate) হিসেবে কাজ করে। ১,৮০০টি টেস্ট কেসের ওপর একক DWT-LSTM ক্লাসিফায়ারটি ৯৮.৮৯\% সামগ্রিক নির্ভুলতা অর্জন করলেও যখন একে রিলের সাথে হাইব্রিড গেটে যুক্ত করা হয়, তখন এটি ফল্ট-রেজিস্ট্যান্স এবং তীব্র নয়েজের মধ্যেও কোনো ফল্ট মিস না করে (Zero False Negatives) শতভাগ নির্ভরযোগ্যতা (100\% Dependability) ও শতভাগ নিরাপত্তা (100\% Security) নিশ্চিত করে। সর্বোপরি, প্রতি প্রেডিকশন স্টেপে মাত্র ০.৭৪ ms ইনফারেন্স ল্যাটেন্সি এবং মাত্র ১৭.২ ms-এর দ্রুততম গড় ফল্ট-ক্লিয়ারিং টাইম (যা প্রচলিত পদ্ধতির চেয়ে ২.৬ গুণ দ্রুত) ট্রান্সফরমারের উইন্ডিংয়ের ওপর তাপীয় ও যান্ত্রিক চাপ হ্রাস করে এমবেডেড রিলে হার্ডওয়্যারে রিয়েল-টাইম সুরক্ষার এক নতুন দিগন্ত উন্মোচন করেছে।
\par}

% ===================== LIST OF NOTATIONS =====================
\frontchaptoc{LIST OF NOTATIONS}
...
\frontchaptoc{LIST OF ABBREVIATIONS}
