...
\title{Hybrid Adaptive Transformer Differential Protection: An Intelligent DWT-LSTM Framework}
%% ==============================================
...
%% First student:
% -----------------
\FirstStudent{Md Moinul Haque}  % Input the FULL NAME of the first student
\FirstRoll{202216206}  % Input the Student Number of the first student
\FirstSurname{Haque}   % Input the SURNAME of the first student

%Second student:
% -----------------
\SecondStudent{Md Reyaz Uddin}  % Input the FULL NAME of the second student
\SecondRoll{202216211}  % Input the Student Number of the second student
\SecondSurname{Uddin}   % Input the SURNAME of the second student
...
\SupervisorAffiliations{Dean, Faculty of Maritime Business Studies}
\SupervisorInstitute{Bangladesh Maritime University}
%
%% ===================================
