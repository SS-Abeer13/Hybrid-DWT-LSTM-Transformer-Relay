...
function setInrush(model)
    disp('═══════════════════════════════════════════════════');
    disp('>>> SCENARIO: MAGNETIZING INRUSH (Loaded Energization)');
    disp('═══════════════════════════════════════════════════');
    % Because the relay defaults to closed, the transformer energizes at t=0.
    % This will simulate a "Loaded Energization" inrush.
